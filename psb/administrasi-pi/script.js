...
function isArabic(text) {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    const SPREADSHEET_ID1 = '1jnRmw7kKu8nOnSeHOBB5Bj37WV7OQpZq7ZKM6oAVj1U';
    const RANGE1 = 'PENDAFTARAN_SANTRI_BARU';
    getData(SPREADSHEET_ID1, RANGE1, 'dataTable1');

    const SPREADSHEET_ID2 = '1jnRmw7kKu8nOnSeHOBB5Bj37WV7OQpZq7ZKM6oAVj1U';
    const RANGE2 = 'ADMINISTRASI_TAHUNAN_SANTRI_BARU';
    getData(SPREADSHEET_ID2, RANGE2, 'dataTable2');

    const SPREADSHEET_ID3 = '1jnRmw7kKu8nOnSeHOBB5Bj37WV7OQpZq7ZKM6oAVj1U';
    const RANGE3 = 'PENDAFTARAN_SANTRI_LAMA';
    getData(SPREADSHEET_ID3, RANGE3, 'dataTable3');

    const SPREADSHEET_ID4 = '1jnRmw7kKu8nOnSeHOBB5Bj37WV7OQpZq7ZKM6oAVj1U';
    const RANGE4 = 'ADMINISTRASI_TAHUNAN_SANTRI_LAMA_KITAB';
    getData(SPREADSHEET_ID4, RANGE4, 'dataTable4');

    const SPREADSHEET_ID5 = '1jnRmw7kKu8nOnSeHOBB5Bj37WV7OQpZq7ZKM6oAVj1U';
    const RANGE5 = 'ADMINISTRASI_TAHUNAN_SANTRI_LAMA_TAHFIDZ';
    getData(SPREADSHEET_ID5, RANGE5, 'dataTable5');

    const SPREADSHEET_ID6 = '1jnRmw7kKu8nOnSeHOBB5Bj37WV7OQpZq7ZKM6oAVj1U';
    const RANGE6 = 'DAFTAR_MADRASAH_PUTRI';
    getData(SPREADSHEET_ID6, RANGE6, 'dataTable6');

    const SPREADSHEET_ID7 = '1jnRmw7kKu8nOnSeHOBB5Bj37WV7OQpZq7ZKM6oAVj1U';
    const RANGE7 = 'ADMINISTRASI_TAHUNAN_MADRASAH';
    getData(SPREADSHEET_ID7, RANGE7, 'dataTable7');

    const SPREADSHEET_ID8 = '1jnRmw7kKu8nOnSeHOBB5Bj37WV7OQpZq7ZKM6oAVj1U';
    const RANGE8 = 'BIAYA_MAKAN_PUTRI';
