...
function isArabic(text) {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    const SPREADSHEET_ID1 = '12PYVK0MoznU6BPXv8Ibx83tx6-eXVM7jOWkdMvQx43A';
    const RANGE1 = 'PENDAFTARAN_SANTRI_BARU';
    getData(SPREADSHEET_ID1, RANGE1, 'dataTable1');

    const SPREADSHEET_ID2 = '12PYVK0MoznU6BPXv8Ibx83tx6-eXVM7jOWkdMvQx43A';
    const RANGE2 = 'ADMINISTRASI_TAHUNAN_SANTRI_BARU';
    getData(SPREADSHEET_ID2, RANGE2, 'dataTable2');

    const SPREADSHEET_ID3 = '12PYVK0MoznU6BPXv8Ibx83tx6-eXVM7jOWkdMvQx43A';
    const RANGE3 = 'PENDAFTARAN_SANTRI_LAMA';
    getData(SPREADSHEET_ID3, RANGE3, 'dataTable3');

    const SPREADSHEET_ID4 = '12PYVK0MoznU6BPXv8Ibx83tx6-eXVM7jOWkdMvQx43A';
    const RANGE4 = 'ADMINISTRASI_TAHUNAN_SANTRI_LAMA';
    getData(SPREADSHEET_ID4, RANGE4, 'dataTable4');

    const SPREADSHEET_ID5 = '12PYVK0MoznU6BPXv8Ibx83tx6-eXVM7jOWkdMvQx43A';
    const RANGE5 = 'DAFTAR_MADRASAH_PUTRA';
