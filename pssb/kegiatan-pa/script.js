...
function isArabic(text) {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    const SPREADSHEET_ID1 = '1-B-HAwdqoYdiY2YxRQEtfUFTD4PQ1eKPz7Rls8rZws0';
    const RANGE1 = 'KEGIATAN_HARIAN_SANTRI_SALAF';
    getData(SPREADSHEET_ID1, RANGE1, 'dataTable1');

    const SPREADSHEET_ID2 = '1-B-HAwdqoYdiY2YxRQEtfUFTD4PQ1eKPz7Rls8rZws0';
    const RANGE2 = 'KEGIATAN_HARIAN_SANTRI_MTS';
    getData(SPREADSHEET_ID2, RANGE2, 'dataTable2');

    const SPREADSHEET_ID3 = '1-B-HAwdqoYdiY2YxRQEtfUFTD4PQ1eKPz7Rls8rZws0';
    const RANGE3 = 'KEGIATAN_MINGGUAN';
    getData(SPREADSHEET_ID3, RANGE3, 'dataTable3');

    const SPREADSHEET_ID4 = '1-B-HAwdqoYdiY2YxRQEtfUFTD4PQ1eKPz7Rls8rZws0';
    const RANGE4 = 'KEGIATAN_TAHUNAN';
